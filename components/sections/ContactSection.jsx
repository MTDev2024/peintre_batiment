...
/**
 * ContactSection — Formulaire de contact + carte OpenStreetMap
 * La logique d'envoi (react-hook-form + API Route Resend) est intégrée en Phase 4.
 */
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* Formulaire */}
          <div>
            {/* TODO Phase 4 — brancher react-hook-form + zod + API Route /api/contact */}
            <form
              noValidate
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  className="w-full px-4 py-3 rounded-lg border border-neutral-200 text-neutral-900 placeholder-neutral-400 bg-neutral-50 focus:bg-white focus:border-accent focus:outline-none transition-colors text-sm resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-accent text-white font-medium py-3.5 px-6 rounded-lg hover:bg-(--color-accent-hover) transition-colors text-base"
              >
                Envoyer ma demande
              </button>
